...
export const MOCKCONTACTS: Contact[] = [
  ...
  // index 13
  {
    id: '4', name: 'Network/OS team', email: ' ', phone: ' ', imageUrl: '../../assets/folder.png', group: [
    {
      id: '2',
      name: 'Bradley Armstrong',
      email: 'armstrongb@byui.edu',
  ...
  // index 14
  {
    id: '6', name: 'Software Development team', email: ' ', phone: ' ', imageUrl: '../../assets/folder.png', group: [
    {
      id: '1',
      name: 'Rex Barzee',
      email: 'barzeer@byui.edu',
  ...
  // index 15
  {
    id: '10', name: 'Web Development team', email: ' ', phone: ' ', imageUrl: '../../assets/folder.png', group: [
    {
      id: '15',
      name: 'Blaine Robertson',
      email: 'robertsonb@byui.edu',
  ...
  // index 16
  {
    id: '14', name: 'Database team', email: ' ', phone: ' ', imageUrl: '../../assets/folder.png', group: [
    {
      id: '7',
      name: 'R. Kent Jackson',
      email: 'jacksonk@byui.edu',
  ...
  // index 17
  {
    id: '18', name: 'Computer Security team', email: ' ', phone: ' ', imageUrl: '../../assets/folder.png', group: [
    {
      id: '5',
      name: 'Kory Godfrey',
      email: 'godfreyko@byui.edu',
